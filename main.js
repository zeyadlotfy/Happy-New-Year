...
let x = setInterval(function () {
  ...
  document.querySelector(".d-s").innerText = addZero(days);
  document.querySelector(".h-s").innerText = addZero(hours);
  document.querySelector(".m-s").innerText = addZero(minutes);
  document.querySelector(".s-s").innerText = addZero(seconds);

  if (distance < 0) {
    clearInterval(x);
    document.querySelector(
      "section"
    ).innerHTML = `<h1 class='new'>Happy New Year!</h1>
      <h5 class="name">Z.L</h5>
      `;
